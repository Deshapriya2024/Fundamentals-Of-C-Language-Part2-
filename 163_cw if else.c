//Q= IN THIS NEW YEAR AN ORGANIZATION IS DECIDED TO GIVE BONOUS TO ITS EMPLOYEE
#include<stdio.h>
int main()
{
	float salary,bonus,totalsalary,extbonus;
	int gen;
	//Male =0 , Female = 1
	...
	printf("\nYour Total salary amount is %.2f",totalsalary);
	return 0;
}
